...
class FirestoreProvider {
  ...
  Stream<DocumentSnapshot> getCommunityItem(String createdAt) =>
      _firestore.collection("community").doc(createdAt).snapshots();
  ...
  Stream<QuerySnapshot> getCommunityItems() {
    return _firestore.collection("community").snapshots();
  }
